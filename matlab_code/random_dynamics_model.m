...
% Section: A
%
% random_dynamics_model - A dynamics model for the particle filter that assumes random motion.  This takes in a scale
% to allow the caller to vary the spread of the motion of the particles
%
function [ legal_moves, prob_distn ] = random_dynamics_model( rand_distn, position, scale )
